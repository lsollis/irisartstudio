...
import com.irisartstudio.repositories.UserRepository;
...
public class UserService {
    ...
    public User register(User newUser, BindingResult result) {
    	...
    	Optional<User> potentialUser = userRepository.findByUserName(newUser.getUserName());
        
        // Reject if email is taken (present in database)
    	if(potentialUser.isPresent()) {
    		result.rejectValue("userName", "Matches", "an account with that user name aready exists");
    	}
    ...
    public User login(LoginUser newLoginObject, BindingResult result) {
    	...
    	Optional<User> potentialUser = userRepository.findByUserName(newLoginObject.getUserName());
